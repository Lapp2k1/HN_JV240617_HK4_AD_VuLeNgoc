...
public class BookManagement {
    ...
    private static void showCart() {
        ...
        if (cartItems.isEmpty()) {
            ...
            System.out.printf("%-10s %-20s %-10s %-10s%n", "ID", "Tên sản phẩm", "Giá", "Số lượng");
            System.out.println("------------------------------------------------------------");
    ...
    private static void updateCartItemQuantity() {
        System.out.print("Nhập ID sản phẩm trong giỏ hàng để cập nhật số lượng: ");
    ...
    private static void removeCartItem() {
        System.out.print("Nhập ID sản phẩm trong giỏ hàng để xóa: ");
        int cartItemId = Integer.parseInt(scanner.nextLine());
